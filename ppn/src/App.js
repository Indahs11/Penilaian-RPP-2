  ...
  diskonChange(event){
	...
	render(){
		return(
          ...
          <label class="form-group-text" class="col-sm-3 col-form-label" >Harga awal  </label>
						<div class="col-sm-9">
            <input type="number" className="form-control" onChange={this.harga_awalChange}/>
						</div>
					</div>
					<div class="form-group row">
           <label class="form-group-text" class="col-sm-3 col-form-label" >PPN </label>
						<div class="col-sm-9">
						<input type="number" className="form-control" onChange={this.ppnChange}/>
            </div>
					</div>
					<div class="form-group row">
						<label class="input-group-text"class="col-sm-3 col-form-label" >Diskon </label>
						<div class="col-sm-9">              
